          ...
          <form onSubmit={handleSubmit} autoComplete="off">
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  <input type={showConfirm ? 'text' : 'password'} id="confirm_password" placeholder="Confirm password" required value={form.confirmPassword} onChange={set('confirmPassword')} style={{ paddingRight: '42px', width: '100%' }} />
