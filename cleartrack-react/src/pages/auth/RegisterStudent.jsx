    ...
    <div className="auth-body">
      <div className="auth-wrapper">
          ...
          <form onSubmit={handleSubmit} autoComplete="off">
            <div className="form-row">
              <div className="form-group">
                ...
                <input type="text" id="fullname" placeholder="Enter your full name" required value={form.fullName} onChange={set('fullName')} />
              </div>
              <div className="form-group">
            ...
            <div className="form-row">
              ...
              <div className="form-group">
                ...
                <select id="class_year" required value={form.classYear} onChange={set('classYear')}>
            ...
            <div className="form-row">
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  <input type={showPassword ? 'text' : 'password'} id="password" placeholder="Min 6 characters" required value={form.password} onChange={set('password')} style={{ paddingRight: '42px', width: '100%' }} />
              ...
              <div className="form-group">
                ...
                <div style={{ position: 'relative' }}>
                  <input type={showConfirm ? 'text' : 'password'} id="confirm_password" placeholder="Repeat password" required value={form.confirmPassword} onChange={set('confirmPassword')} style={{ paddingRight: '42px', width: '100%' }} />
                  <button type="button" onClick={() => setShowConfirm(s => !s)} style={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', cursor: 'pointer', color: 'var(--text-sub)', padding: '4px' }}>
            ...
            <button type="submit" className="btn btn-primary btn-full" style={{ marginTop: '6px' }} disabled={loading}>
        ...
        <p className="auth-footer">
          Already registered? <Link to="/login/student">Back to Login</Link>
        </p>
      </div>
    </div>
  )
