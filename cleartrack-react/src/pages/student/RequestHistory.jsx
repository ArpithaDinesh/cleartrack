                      ...
                      <tr key={r._id}>
                        ...
                        <td>
                          {r.receiptFile?.filename && (
                            <a href={r.receiptFile?.base64Data || `${API_ROOT}/uploads/${r.receiptFile?.filename}`} target="_blank" rel="noreferrer" className="btn btn-sm btn-outline" style={{padding:'4px 8px', fontSize:'.7rem'}}>
                              View Bill
                            </a>
                          )}
                        </td>
